                                ...
                                <div class="tab-pane fade show {{ $loop->index === 0 ? 'active' : '' }}"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input name="description[{{ $language->id }}][fan_count]" type="text" class="form-control" id="description-fan-count-{{ $language->id }}" value="{{ old('description.' . $language->id . '.fan_count') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="description[{{ $language->id }}][language_id]" type="hidden" value="{{ $language->id }}">
                                            <input name="description[{{ $language->id }}][fan_type]" type="text" class="form-control" id="description-fan-type-{{ $language->id }}" value="{{ old('description.' . $language->id . '.fan_type') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="description[{{ $language->id }}][language_id]" type="hidden" value="{{ $language->id }}">
                                            <input name="description[{{ $language->id }}][button_text]" type="text" class="form-control" id="description--button-text-{{ $language->id }}" value="{{ old('description.' . $language->id . '.button_text') }}">
