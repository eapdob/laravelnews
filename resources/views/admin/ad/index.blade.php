                ...
                <form action="{{ route('admin.ad.update', 1) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div id="image-preview-top-bar-ad">
                            <label for="image-upload-top-bar-ad"
                                   id="image-label-top-bar-ad">{{ __('admin.Choose file') }}</label>
                            <input type="file" name="home_top_bar_ad" id="image-upload-top-bar-ad">
                            <input type="hidden" name="old_home_top_bar_ad"
                                   value="{{ old('home_top_bar_ad') ? old('home_top_bar_ad') : asset($ad->home_top_bar_ad ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="home_top_bar_ad_url" class="mt-3">{{ __('admin.Top bar ad url') }}</label>
                        <input name="home_top_bar_ad_url"
                               value="{{ old('home_top_bar_ad_url') ? old('home_top_bar_ad_url') : ($ad->home_top_bar_ad_url ?? '') }}"
                               type="text"
                        ...
                        <label class="custom-switch mt-2">
                            <input
                                ...
                                class="custom-switch-input toggle-status" {{ old('home_top_bar_ad_status') === 1 ? 'selected' : ((isset($ad->home_top_bar_ad_status) && $ad->home_top_bar_ad_status == 1) ? 'checked' : '') }}>
                    ...
                    <div class="form-group">
                        ...
                        <div id="image-preview-middle-ad">
                            <label for="image-upload-middle-ad"
                                   id="image-label-middle-ad">{{ __('admin.Choose file') }}</label>
                            <input type="file" name="home_middle_ad" id="image-upload-middle-ad">
                            <input type="hidden" name="old_home_middle_ad"
                                   value="{{ old('home_middle_ad') ? old('home_middle_ad') : asset($ad->home_middle_ad ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="home_middle_ad_url" class="mt-3">{{ __('admin.Middle ad url') }}</label>
                        <input name="home_middle_ad_url"
                               value="{{ old('home_middle_ad_url') ? old('home_middle_ad_url') : ($ad->home_middle_ad_url ?? '') }}"
                               type="text"
                        ...
                        <label class="custom-switch mt-2">
                            <input
                                ...
                                value="1" type="checkbox"
                                class="custom-switch-input toggle-status" {{ old('home_middle_ad_status') === 1 ? 'selected' : ((isset($ad->home_middle_ad_status) && $ad->home_middle_ad_status == 1) ? 'checked' : '') }}>
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="image-preview-view-page-ad">
                            <label for="image-upload-view-page-ad"
                                   id="image-label-view-page-ad">{{ __('admin.Choose file') }}</label>
                            <input type="file" name="view_page_ad" id="image-upload-view-page-ad">
                            <input type="hidden" name="old_view_page_ad"
                                   value="{{ old('view_page_ad') ? old('view_page_ad') : asset($ad->view_page_ad ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="view_page_ad_url" class="mt-3">{{ __('admin.Bottom ad url') }}</label>
                        <input name="view_page_ad_url"
                               value="{{ old('view_page_ad_url') ? old('view_page_ad_url') : ($ad->view_page_ad_url ?? '') }}"
                               type="text"
                        ...
                        <label class="custom-switch mt-2">
                            <input
                                ...
                                value="1" type="checkbox"
                                class="custom-switch-input toggle-status" {{ old('view_page_ad_status') === 1 ? 'selected' : ((isset($ad->view_page_ad_status) && $ad->view_page_ad_status == 1) ? 'checked' : '') }}>
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="image-preview-news-page-ad">
                            <label for="image-upload-news-page-ad"
                                   id="image-label-news-page-ad">{{ __('admin.Choose file') }}</label>
                            <input type="file" name="news_page_ad" id="image-upload-news-page-ad">
                            <input type="hidden" name="old_news_page_ad"
                                   value="{{ old('news_page_ad') ? old('news_page_ad') : asset($ad->news_page_ad ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="news_page_ad_url" class="mt-3">{{ __('admin.Bottom ad url') }}</label>
                        <input name="news_page_ad_url"
                               value="{{ old('news_page_ad_url') ? old('news_page_ad_url') : ($ad->news_page_ad_url ?? '') }}"
                               type="text"
                        ...
                        <label class="custom-switch mt-2">
                            <input
                                ...
                                value="1" type="checkbox"
                                class="custom-switch-input toggle-status" {{ old('news_page_ad_status') === 1 ? 'selected' : ((isset($ad->news_page_ad_status) && $ad->news_page_ad_status == 1) ? 'checked' : '') }}>
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="image-preview-side-bar-ad">
                            <label for="image-upload-side-bar-ad"
                                   id="image-label-side-bar-ad">{{ __('admin.Choose file') }}</label>
                            <input type="file" name="side_bar_ad" id="image-upload-side-bar-ad">
                            <input type="hidden" name="old_side_bar_ad"
                                   value="{{ old('side_bar_ad') ? old('side_bar_ad') : asset($ad->side_bar_ad ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="side_bar_ad_url" class="mt-3">{{ __('admin.Sidebar ad url') }}</label>
                        <input name="side_bar_ad_url"
                               value="{{ old('side_bar_ad_url') ? old('side_bar_ad_url') : ($ad->side_bar_ad_url ?? '') }}"
                               type="text"
                        ...
                        <label class="custom-switch mt-2">
                            <input
                                ...
                                value="1" type="checkbox"
                                class="custom-switch-input toggle-status" {{ old('side_bar_ad_status') === 1 ? 'selected' : ((isset($ad->side_bar_ad_status) && $ad->side_bar_ad_status == 1) ? 'checked' : '') }}>
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </div>
