                                ...
                                <div class="tab-pane fade show {{ $loop->index === 0 ? 'active' : '' }}"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input name="description[{{ $language->id }}][title]" type="text" class="form-control" id="description-title-{{ $language->id }}" value="{{ old('description.' . $language->id . '.title') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description[{{ $language->id }}][content]" class="summernote-simple" id="description-content-{{ $language->id }}">{{ old('description.' . $language->id . '.content') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="description[{{ $language->id }}][meta_title]" type="text" class="form-control" id="description-meta-title-{{ $language->id }}" value="{{ old('description.' . $language->id . '.meta_title') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="description[{{ $language->id }}][meta_description]" type="text" class="form-control" id="description-meta-description-{{ $language->id }}" value="{{ old('description.' . $language->id . '.meta_description') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="description[{{ $language->id }}][tags]" type="text" class="form-control inputtags" id="description-tags-{{ $language->id }}" value="{{ old('description.' . $language->id . '.tags') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                    <input type="checkbox" name="status" class="custom-switch-input" value="1" {{ old('status') == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="custom-switch mt-2">
                                        <input value="1" type="checkbox" name="show_at_slider"
                                               class="custom-switch-input" {{ old('show_at_slider') == 1 ? 'checked' : '' }}>
                                        <span class="custom-switch-indicator"></span>
                                    </label>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#image-preview').css({
                "background-image": "url({{ old('image') }})",
